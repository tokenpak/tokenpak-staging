...
TokenPak is licensed under the Apache License, Version 2.0. See [LICENSE](./LICENSE) for details.
...
TokenPak and all features remain the intellectual property of TokenPak. The Apache 2.0 license grants usage rights as described in [LICENSE](./LICENSE).
