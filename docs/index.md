...
TokenPak is an open-source LLM proxy that performs Prompt Packing, routes requests intelligently, and tracks costs — all without touching your prompts or credentials.
