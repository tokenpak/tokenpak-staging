...
export interface HealthMemoryGuardEnabled {
    enabled: true;
    state: 'created' | 'unsupported' | 'running' | 'start_failed' | 'stopped' | 'stop_timeout' | 'degraded';
    thread_alive: boolean;
    callback_policy: 'caller_supplied_eviction_callbacks' | 'gc_trim_only_no_unbounded_disposable_proxy_cache';
    configuration: HealthMemoryGuardConfiguration;
    callbacks: HealthMemoryGuardCallbacks;
    checks: number;
