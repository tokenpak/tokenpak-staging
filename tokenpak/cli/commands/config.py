...
TOKENPAK_VARS = [
    ...
    ("TOKENPAK_COMPACT", "Compatibility flag (no default HTTP effect)"),
    ("TOKENPAK_COMPACT_THRESHOLD_TOKENS", "Explicit compact helper threshold (tokens)"),
    ("TOKENPAK_COMPACT_MAX_CHARS", "Explicit compact helper max text chars"),
    ("TOKENPAK_COMPACT_CACHE_SIZE", "Explicit compact helper cache size"),
