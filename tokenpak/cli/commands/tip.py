...
def run_conformance_checks() -> list[CheckResult]:
    ...
    # 5. Pak contract importable (the MultiPak Pro design prerequisite)
    try:
...
your platform's adapter-registration entrypoint. See the provider-adapter contract (provider
adapter standard) for the additive-only contract.
"""
