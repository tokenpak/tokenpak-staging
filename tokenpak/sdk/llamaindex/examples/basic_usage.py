"""
Basic usage examples for tokenpak.sdk.llamaindex.

Run with: python examples/basic_usage.py
(No LlamaIndex installation required; these examples use mock engines.)
"""
...
def example_node_conversion() -> None:
    print("=" * 60)
    print("Example 1: Node to Block conversion")
    print("=" * 60)
...
def example_multi_index_fusion() -> None:
    print("=" * 60)
...
def main() -> None:
    example_node_conversion()
    example_synthesizer()
    example_query_engine()
    example_multi_index_fusion()
    print("=" * 60)
