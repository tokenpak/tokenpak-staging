...
Deterministic eval mode (``[TIP: deterministic=on]`` — PROP4-1B / Std 31 draft):
...
class SemanticCache:
    ...
    def lookup(
        ...
        *,
        ...
        mode — PROP4-1B / Std 31 draft) disables semantic response
    ...
    def store(
        ...
        *,
        ...
        ``deterministic=True`` (reproducible eval mode — PROP4-1B): the store
