...
class RetryEngine:
    ...
    deterministic : bool
        ...
        draft). When True, ALL escalation is disabled: exactly one attempt of
    ...
    def _run_deterministic(self) -> Any:
        ...
        PROP4-1B contract: proxy/orchestration retries disabled, no model
        downgrade, no cross-provider fallback, no handoff. One attempt of
