...
Lane 1 of the tokenpak UX onboarding initiative (p0-tokenpak-ux-lane1-
stop-the-bleeding) — every printed `export NAME='value'` example used to
...
Pure stdlib (per the packet's hard constraints). Output is always a
