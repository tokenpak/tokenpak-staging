...
class TestDetectProviderExactHosts:
    ...
    def test_gemini_exact(self):
        assert detect_provider("https://generativelanguage.googleapis.com/v1beta") == Provider.GEMINI
    ...
    def test_fireworks_exact(self):
        assert detect_provider("https://api.fireworks.ai/inference/v1/chat/completions") == Provider.FIREWORKS
...
class TestDetectProviderSuffixRules:
    ...
    def test_gemini_googleapis_subdomain(self):
        assert detect_provider("https://us-central1-aiplatform.googleapis.com/v1/projects") == Provider.GEMINI

    def test_groq_subdomain(self):
        assert detect_provider("https://api-eu.groq.com/openai/v1/chat/completions") == Provider.GROQ
