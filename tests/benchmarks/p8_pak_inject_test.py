...
Per methodology §3.4, semantic-cache PAK *retrieval* (scoring/ranking, Std 32 §5
Phase 2) is a separate measurement layered on top of this and is intentionally
out of scope here; this target measures the body byte-splice the proxy performs
on every injected request.
