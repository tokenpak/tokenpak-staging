...
Pins stub #9 of the silent-failure-surfaces coverage lane
(`p0-regression-coverage-waveC-cli-licensing`). The single Pro choke point
is ``tokenpak.licensing.is_feature_enabled``; its status gate
